...
if ~exist('h1_HEV_powersplit_adapted', 'var') || ...
        ~isgraphics(h1_HEV_powersplit_adapted, 'figure')
    h1_HEV_powersplit_adapted = figure('Name', 'HEV_powersplit_adapted');
end
figure(h1_HEV_powersplit_adapted)
clf(h1_HEV_powersplit_adapted)

% Get simulation results
simlog_t      = logsout_HEV_powersplit_adapted.get('RefSpd').Values.Time;
simlog_RefSpd = logsout_HEV_powersplit_adapted.get('RefSpd').Values.Data;
simlog_vehSpd = logsout_HEV_powersplit_adapted.get('vehSpd').Values.Data;
