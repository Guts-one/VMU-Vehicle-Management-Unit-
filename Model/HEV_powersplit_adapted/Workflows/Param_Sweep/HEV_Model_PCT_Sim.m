%% Script to run HEV_powersplit_adapted in parallel
...
% Plot Results
fig_handle_name = 'h4_hev_powersplit_adapted_pct';
...
for i=length(simOut):-1:1
    data = simOut(i).simlog_HEV_powersplit_adapted.Electrical.Motor.System.Motor_and_Drive.t.series;
