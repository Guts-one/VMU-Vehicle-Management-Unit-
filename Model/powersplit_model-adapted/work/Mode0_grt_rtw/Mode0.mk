###########################################################################
## Makefile generated for component 'Mode0'. 
## 
## Makefile     : Mode0.mk
## Generated on : Tue Mar 24 15:01:37 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Mode0.exe
...
COMPILER_COMMAND_FILE     = Mode0_comp.rsp
CMD_FILE                  = Mode0.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Mode0.exe
...
DEFINES_STANDARD = -DMODEL=Mode0 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/Mode0_grt_rtw/Mode0.c $(START_DIR)/Mode0_grt_rtw/rtGetInf.c $(START_DIR)/Mode0_grt_rtw/rtGetNaN.c $(START_DIR)/Mode0_grt_rtw/rt_nonfinite.c
...
OBJS = rt_logging.obj Mode0.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj
...
%.obj : $(START_DIR)/Mode0_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Mode0_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Mode0_grt_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Mode0_grt_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Mode0_grt_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Mode0.obj : $(START_DIR)/Mode0_grt_rtw/Mode0.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/Mode0_grt_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/Mode0_grt_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/Mode0_grt_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
