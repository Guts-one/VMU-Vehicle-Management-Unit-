...
int32_T HEV_SeriesParallel_c0f8494c_49_ds_dxicr_p(const NeDynamicSystem *LC,
  const NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  (void)t1;
  (void)LC;
  out->mDXICR_P.mNumCol = 58ULL;
  out->mDXICR_P.mNumRow = 6ULL;
  ...
  out->mDXICR_P.mJc[25] = 0;
  out->mDXICR_P.mJc[26] = 0;
  out->mDXICR_P.mJc[27] = 0;
  out->mDXICR_P.mJc[28] = 0;
  out->mDXICR_P.mJc[29] = 0;
  out->mDXICR_P.mJc[30] = 0;
  out->mDXICR_P.mJc[31] = 0;
  out->mDXICR_P.mJc[32] = 0;
  out->mDXICR_P.mJc[33] = 0;
  out->mDXICR_P.mJc[34] = 0;
  out->mDXICR_P.mJc[35] = 0;
  out->mDXICR_P.mJc[36] = 0;
  out->mDXICR_P.mJc[37] = 0;
  out->mDXICR_P.mJc[38] = 0;
  out->mDXICR_P.mJc[39] = 0;
  out->mDXICR_P.mJc[40] = 0;
  out->mDXICR_P.mJc[41] = 0;
  out->mDXICR_P.mJc[42] = 0;
  out->mDXICR_P.mJc[43] = 0;
  out->mDXICR_P.mJc[44] = 0;
  out->mDXICR_P.mJc[45] = 0;
  out->mDXICR_P.mJc[46] = 0;
  out->mDXICR_P.mJc[47] = 0;
  out->mDXICR_P.mJc[48] = 0;
  out->mDXICR_P.mJc[49] = 0;
  out->mDXICR_P.mJc[50] = 0;
  out->mDXICR_P.mJc[51] = 0;
  out->mDXICR_P.mJc[52] = 0;
  out->mDXICR_P.mJc[53] = 0;
  out->mDXICR_P.mJc[54] = 0;
  out->mDXICR_P.mJc[55] = 0;
  out->mDXICR_P.mJc[56] = 0;
  out->mDXICR_P.mJc[57] = 0;
  out->mDXICR_P.mJc[58] = 0;
  (void)LC;
  (void)out;
  return 0;
}
