...
## 
## Makefile     : Control.mk
## Generated on : Tue Mar 24 15:00:50 2026
...
DEFINES_STANDARD = -DMODEL=Control -DNUMST=3 -DNCSTATES=8 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/Control_grt_rtw/Control.c $(START_DIR)/Control_grt_rtw/Control_data.c $(START_DIR)/Control_grt_rtw/rtGetInf.c $(START_DIR)/Control_grt_rtw/rtGetNaN.c $(START_DIR)/Control_grt_rtw/rt_nonfinite.c $(START_DIR)/Control_grt_rtw/rt_zcfcn.c $(START_DIR)/Control_grt_rtw/rtmodel.c
...
OBJS = rt_logging.obj Control.obj Control_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_zcfcn.obj rtmodel.obj
...
%.obj : $(START_DIR)/Control_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Control_grt_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Control_grt_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Control_grt_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Control.obj : $(START_DIR)/Control_grt_rtw/Control.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Control_data.obj : $(START_DIR)/Control_grt_rtw/Control_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/Control_grt_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/Control_grt_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/Control_grt_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_zcfcn.obj : $(START_DIR)/Control_grt_rtw/rt_zcfcn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtmodel.obj : $(START_DIR)/Control_grt_rtw/rtmodel.c
	$(CC) $(CFLAGS) -o "$@" "$<"
